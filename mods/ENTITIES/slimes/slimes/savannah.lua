mobs:register_mob("slimes:savannah_slime", {
	group_attack = true,
	type = "monster",
	passive = false,
	...
	visual = "mesh",
	mesh = "slime_land.b3d",
	blood_texture = "slime_goo.png^[colorize:"..slimes.colors["savannah"],
	textures = {
		{"slime_goo_block.png^[colorize:"..slimes.colors["savannah"],"slime_goo_block.png^[colorize:"..slimes.colors["savannah"],"slime_goo_block.png^[colorize:"..slimes.colors["savannah"]},
	},
        sounds = {
	...
	view_range = 15,
	drops = {
		{name = "slimes:savannah_goo", chance = 1, min = 0, max = 2},
	},
	water_damage = 0,
	lava_damage = 8,
	light_damage = 0,
...
minetest.override_item("slimes:savannah_goo", {on_use = minetest.item_eat(1)})

if minetest.registered_items["mesecons_materials:glue"] then
	minetest.register_craft({
		type = "cooking",
		output = "mesecons_materials:glue",
		recipe = "slimes:savannah_goo"
	})
end

mobs:spawn({
	name = "slimes:savannah_slime",
	nodes = {
