...
local ocelot = {
	...
	fear_height = 4,
	sounds = {
		random = "mobs_animal_ocelot_random",
		damage = "mobs_animal_ocelot_pain",
...
mobs:register_egg("mobs_mc:ocelot", "Ocelot Spawn Egg", "wool_orange.png", 1)
mobs:register_egg("mobs_mc:cat", "Cat Spawn Egg", "wool_orange.png", 1)
