...
mobs:register_mob("mesecraft_mobs:turtle", {
	type = "animal",
	passive = true,
	runaway = true,
	stepheight = 1.2,
	...
	visual = "mesh",
	mesh = "mesecraft_mobs_turtle.b3d",
	textures = {
		{"mesecraft_mobs_turtle.png"},
	},
	visual_size = {x=3, y=3},
	walk_velocity = 0.6,
	run_velocity = 2,
