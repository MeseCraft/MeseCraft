...
mobs:register_arrow("mesecraft_mobs:snowmans_snowball", {
	visual = "sprite",
	visual_size = {x=.5, y=.5},
...
mobs:register_mob("mesecraft_mobs:snowman", {
	type = "monster",
	hp_min = 20,
	hp_max = 20,
	pathfinding = 1,
	...
	visual = "mesh",
	mesh = "mesecraft_mobs_snowman.b3d",
	textures = {
		{"mesecraft_mobs_snowman.png^transparent_pixel.png"},
	},
	drops = {
	...
	attack_type = "shoot",
	arrow = "mesecraft_mobs:snowmans_snowball",
	shoot_interval = 2,
	shoot_offset = 1,
	animation = {
		speed_normal = 25,
...
-- Spawn Parameters
mobs:spawn_specific("mesecraft_mobs:snowman", {"default:snow", "default:snowblock", "default:dirt_with_snow"},{"air"},0,7,240,4000,2,-10,200)

-- Spawn Egg
mobs:register_egg("mesecraft_mobs:snowman", "Snowman", "default_snow.png", 1)
