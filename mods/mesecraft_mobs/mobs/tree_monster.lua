...
mobs:register_mob("mesecraft_mobs:tree_monster", {
	type = "monster",
	passive = false,
	...
	visual = "mesh",
	mesh = "mesecraft_mobs_tree_monster.b3d",
	textures = {
		{"mesecraft_mobs_tree_monster.png"},
		{"mesecraft_mobs_tree_monster2.png"},
	},
...
mobs:spawn_specific("mesecraft_mobs:tree_monster", {"group:leaves"}, {"air"}, 0, 7, 240, 4000, 1, 0, 100, false)

-- REGISTER SPAWN EGG
mobs:register_egg("mesecraft_mobs:tree_monster", "Tree Monster", "default_tree_top.png", 1)
