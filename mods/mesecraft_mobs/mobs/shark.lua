...
mobs:register_mob("mesecraft_mobs:shark", {
	type = "monster",
	...
	visual = "mesh",
	mesh = "mesecraft_mobs_shark.b3d",
	rotate = 90,
	textures = 	{"mesecraft_mobs_shark.png"},
	sounds = {
	        attack = "mesecraft_mobs_shark_attack",
	        damage = "mesecraft_mobs_shark_damage",
	        death = "mesecraft_mobs_shark_death",
        },
