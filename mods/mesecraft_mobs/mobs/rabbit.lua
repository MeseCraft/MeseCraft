...
mobs:register_mob("mesecraft_mobs:rabbit",{
	type = "animal",
	passive = true,
	reach = 1,
	hp_min = 3,
	...
	visual = "mesh",
	mesh = "mesecraft_mobs_rabbit.b3d",
	textures = {
        {"mesecraft_mobs_rabbit_brown.png"},
        {"mesecraft_mobs_rabbit_gold.png"},
        {"mesecraft_mobs_rabbit_white.png"},
        {"mesecraft_mobs_rabbit_white_splotched.png"},
        {"mesecraft_mobs_rabbit_salt.png"},
        {"mesecraft_mobs_rabbit_black.png"},
	{"mesecraft_mobs_rabbit_toast.png"},
	},
	visual_size = {x=1.5, y=1.5},
	sounds = {
	random = "mesecraft_mobs_rabbit_random",
	jump = "mesecraft_mobs_rabbit_jump",
	damage = "mesecraft_mobs_rabbit_pain",
	death = "mesecraft_mobs_rabbit_death",	
	},
	...
	jump = true,
	drops = {
		{name = "mesecraft_mobs:rabbit_raw", chance = 1, min = 0, max = 1},
		{name = "mesecraft_mobs:rabbit_hide", chance = 1, min = 0, max = 1},
	},
	water_damage = 4,
	lava_damage = 4,
	light_damage = 0,
	...
	-- Follow (yellow) dangelions, carrots
...
spawn_desert.on_spawn = function(self, pos)
	local texture = "mesecraft_mobs_rabbit_gold.png"
	self.base_texture = {"mesecraft_mobs_rabbit_gold.png"}
...
spawn_snow.on_spawn = function(self, pos)
	...
	-- 80% white fur
	if r <= 80 then
		texture = "mesecraft_mobs_rabbit_white.png"
	-- 20% black and white fur
	else
		texture = "mesecraft_mobs_rabbit_white_splotched.png"
	end
...
spawn_grass.on_spawn = function(self, pos)
	...
	-- 50% brown fur
	if r <= 50 then
		texture = "mesecraft_mobs_rabbit_brown.png"
	-- 40% salt fur
	elseif r <= 90 then
		texture = "mesecraft_mobs_rabbit_salt.png"
	-- 10% black fur
	else
		texture = "mesecraft_mobs_rabbit_black.png"
	end
	self.base_texture = { texture }
	self.object:set_properties({textures = self.base_texture})
end
...
-- Spawn egg
mobs:register_egg("mesecraft_mobs:rabbit", "Rabbit Spawn Egg", "wool_brown.png", 1)
