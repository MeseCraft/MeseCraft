-- MANCUBUS
mobs:register_mob("mesecraft_mobs:mancubus", {
   type = "monster",
   passive = false,
   reach = 2,
   attack_type = "shoot",
   shoot_interval = 4.0,
   arrow = "mesecraft_mobs:a_mancubus_rocket",
   shoot_offset = 1,
   hp_min = 50,
   hp_max = 50,
   armor = 100,
   ...
   sounds = {
                ...
                war_cry = "mesecraft_mobs_mancubus_warcry",
...
-- REGISTER PROJECTILE
mobs:register_arrow("mesecraft_mobs:a_mancubus_rocket", {
   visual = "sprite",
   visual_size = {x = 1, y = 1},
...
mobs:spawn_specific("mesecraft_mobs:mancubus", {"nether:sand","nether:glowstone","default:lava_source"}, {"air"}, 0, 16, 480, 3000, 4, -30912, -16000)

-- REGISTER SPAWN EGG
mobs:register_egg("mesecraft_mobs:mancubus", "Mancubus Spawn Egg", "default_sand.png", 1)
