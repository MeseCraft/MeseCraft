...
--register spider mob
mobs:register_mob("mesecraft_mobs:spider", {
	type = "animal",
	passive = true,
	runaway = true,
	hp_min = 1,
...
mobs:spawn_specific("mesecraft_mobs:spider", { "group:cracky", "group:crumbly", "group:shovely", "group:pickaxey" }, {"air"}, 0, 7, 960, 2000, 1, -28000, 150)
mobs:register_egg("mesecraft_mobs:spider", "Spider Spawn Egg", "wool_black.png", 1)
