...
mobs:register_mob("mesecraft_mobs:bogeyman", {
   type = "monster",
   passive = false,
   damage = 9,
   reach = 2,
   ...
   textures = {
      {"mesecraft_mobs_bogeyman.png"},
   },
   blood_amount = 4,
   blood_texture = "mesecraft_mobs_common_shadow.png",
...
mobs:spawn_specific("mesecraft_mobs:bogeyman", {"group:cracky", "group:crumbly", "group:shovely", "group:pickaxey"}, {"air"}, 0, 1, 480, 25000, 2, 0, 100, false)
mobs:register_egg("mesecraft_mobs:bogeyman", "Bogeyman Spawn Egg", "wool_black.png", 1)
