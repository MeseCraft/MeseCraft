-- Disc registrations
-- Music track licenses can be found on the README.md file
gramophone.register_disc("Für Elise", "Ludwig van Beethoven", "#ffcfac", "default_music_track1_fur_elise")
gramophone.register_disc("King Stephen", "Ludwig van Beethoven", "#abcbff", "default_music_track2_king_stephen")
gramophone.register_disc("Brandenburg Concerto no. 2 - Allegro", "Johann Sebastian Bach", "#acb1ff", "default_music_track3_allegro")
gramophone.register_disc("Brandenburg Concerto no. 2 - Andante", "Johann Sebastian Bach", "#fff9ac", "default_music_track4_andante")
