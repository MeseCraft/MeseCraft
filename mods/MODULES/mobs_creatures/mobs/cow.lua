...
mobs:register_mob("mobs_creatures:cow", {
	type = "animal",
	hp_min = 10,
	hp_max = 10,
...
mobs:spawn_specific("mobs_creatures:cow", {"default:dirt", "default:dirt_with_grass", "ethereal:prairie_dirt", "ethereal:mushroom_dirt"}, {"air"}, 9, 15, 120, 5000, 4, 0, 200)

-- Register Cow Spawn Egg
mobs:register_egg("mobs_creatures:cow", "Cow Spawn Egg", "wool_brown.png", 1)
