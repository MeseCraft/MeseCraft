...
local ocelot = {
	...
	visual = "mesh",
	mesh = "mobs_creatures_cat.b3d",
	textures = {"mobs_creatures_cat_ocelot.png"},
	...
	fear_height = 4,
	sounds = {
		random = "mobs_creatures_ocelot_random",
		damage = "mobs_creatures_ocelot_pain",
		distance = 16,
	},
	animation = {
	...
	follow = {"mobs_creatures:milk_bucket", "mobs_creatures:milk_glass", "mobs_creatures:chicken_raw", "mobs_creatures:chicken_cooked", "mobs_creatures:cod_raw", "mobs_creatures:cod_cooked", "mobs_creatures:clownfish_raw", "mobs_creatures:clownfish_cooked", "mobs_creatures:rabbit_raw", "mobs_creatures:rabbit_cooked", "mobs_creatures:salmon_raw", "mobs_creatures:salmon_cooked",},
	view_range = 12,
	passive = true,
	...
	reach = 1,
	attack_animals = true,
	specific_attack = { "mobs_creatures:chicken" },
-- FROM WOLF	
...
mobs:register_mob("mobs_creatures:ocelot", ocelot)

-- Cat
local cat = table.copy(ocelot)
cat.textures = {{"mobs_creatures_cat_black.png"}, {"mobs_creatures_cat_red.png"}, {"mobs_creatures_cat_siamese.png"}}
cat.owner = ""
...
mobs:register_mob("mobs_creatures:cat", cat)

-- Spawn ocelot
mobs:spawn({
	name = "mobs_creatures:ocelot",
	...
	on_spawn = function(self, pos)
		...
		if pr:next(1,7) == 1 then
			...
			for i=1, 2 do
				...
				make_child(minetest.add_entity(child_pos, "mobs_creatures:ocelot"))
			end
		end
	end,
})
...
mobs:register_egg("mobs_creatures:ocelot", "Ocelot Spawn Egg", "wool_orange.png", 1)
mobs:register_egg("mobs_creatures:cat", "Cat Spawn Egg", "wool_orange.png", 1)
