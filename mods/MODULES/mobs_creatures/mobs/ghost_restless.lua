...
mobs:register_mob('mobs_creatures:restless_ghost', {
	type = "monster",
	passive = false,
	group_attack = true,
...
--		attack = "mobs_creatures_ghost_attack", -- disabling this because it gets really annoying.
...
--Spawn Eggs
mobs:register_egg("mobs_creatures:restless_ghost", "Restless Ghost Spawn Egg", "wool_white.png", 1)

--Spawn Functions
mobs:spawn_specific("mobs_creatures:restless_ghost", {"mesecraft_bones:bones"}, {"air"}, 0, 7, 600, 100, 2, -30912, 30912, false)
