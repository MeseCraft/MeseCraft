...
mobs:register_mob("mobs_creatures:snapper", {
	type = "animal",
	passive = true,
	runaway = true,
        runaway_from = {"player"},
	...
	visual = "mesh",
	mesh = "mobs_creatures_snapper.b3d",
    textures = {
        { "mobs_creatures_snapper_1.png"},
	{ "mobs_creatures_snapper_2.png"},
        { "mobs_creatures_snapper_3.png"},
        { "mobs_creatures_snapper_4.png"},
        { "mobs_creatures_snapper_5.png"},
        { "mobs_creatures_snapper_6.png"},
	},
	visual_size = {x=3, y=3},
        drops = {
               {name = "mobs_creatures:snapper_raw", chance = 1, min = 1, max = 1},
