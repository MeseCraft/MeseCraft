...
mobs:register_mob("mobs_creatures:diamond_man", {
	type = "monster",
	passive = false,
	...
	armor = 25,
        ...
        textures = {
                {"mobs_creatures_diamond_man.png"},
        },
...
-- Spawning Parameters
mobs:spawn_specific("mobs_creatures:diamond_man", {"group:cracky", "group:crumbly", "group:shovely", "group:pickaxey"}, {"air", "mine_gas:gas"}, 0, 7, 240, 12000, 1, -9500, -6500)

-- Register Spawn Egg
mobs:register_egg("mobs_creatures:diamond_man", "Diamond Man Spawn Egg", "default_diamond.png", 1)
