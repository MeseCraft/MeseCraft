...
mobs:register_mob("mobs_creatures:dirt_man", {
	type = "monster",
	passive = false,
...
mobs:spawn_specific("mobs_creatures:dirt_man", {"default:dirt_with_grass", "ethereal:gray_dirt"}, {"air"}, 0, 7, 60, 5000, 2, -500, 100, false)

-- Register Spawn Egg
mobs:register_egg("mobs_creatures:dirt_man", "Dirt Man Spawn Egg", "default_dirt.png", 1)
