...
-- Register Mob
mobs:register_mob("mobs_creatures:stone_man", {
	type = "monster",
	passive = false,
...
-- Spawning Parameters
mobs:spawn_specific("mobs_creatures:stone_man", {"default:stone", "default:desert_stone"}, {"air"}, 0, 7, 960, 2000, 1, -500, 100, false)

-- Register Spawn Egg
mobs:register_egg("mobs_creatures:stone_man", "Stone Man Spawn Egg", "default_stone.png", 1)
