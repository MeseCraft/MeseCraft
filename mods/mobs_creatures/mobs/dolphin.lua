...
mobs:register_mob("mobs_creatures:dolphin", {
	type = "animal",
	group_attack = true,
	passive = true,
	runaway = true,
	...
	visual = "mesh",
	mesh = "mobs_creatures_dolphin.b3d",
	textures = {
		{"mobs_creatures_dolphin.png"},
	},
        drops = {
               {name = "mobs_creatures:cod_raw", chance = 1, min = 0, max = 4},
        },
	visual_size = {x=3, y=3},
	walk_velocity = 0.6,
	run_velocity = 2,
