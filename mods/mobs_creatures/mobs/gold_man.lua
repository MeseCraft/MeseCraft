...
mobs:register_mob("mobs_creatures:gold_man", {
	type = "monster",
	passive = false,
...
-- Spawning Parameters
mobs:spawn_specific("mobs_creatures:gold_man", {"group:cracky", "group:crumbly", "group:shovely", "group:pickaxey"}, {"air", "mine_gas:gas"}, 0, 7, 600, 4000, 1, -9500, -6500)

-- Register Spawn Egg
mobs:register_egg("mobs_creatures:gold_man", "Gold Man Spawn Egg", "default_gold_block.png", 1)
