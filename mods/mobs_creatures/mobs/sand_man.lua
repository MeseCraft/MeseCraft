...
mobs:register_mob("mobs_creatures:sand_man", {
	type = "monster",
	passive = false,
...
mobs:spawn_specific("mobs_creatures:sand_man", {"default:sand", "default:desert_sand"}, {"air"}, 0, 7, 480, 1200, 2, -500, 100, false)

-- Register Spawn Egg
mobs:register_egg("mobs_creatures:sand_man", "Sand Man Spawn Egg", "default_desert_sand.png", 1)
