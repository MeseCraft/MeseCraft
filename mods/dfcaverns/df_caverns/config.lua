...
setting("int", "ymax", -513, "Upper limit of level 1")
setting("int", "level1_min", -3552, "Upper limit of level 2")
setting("int", "level2_min", -6512, "Upper limit of level 3")
setting("int", "level3_min", -9552, "Upper limit of the sunless seas")
setting("int", "sunless_sea_min", -10992, "Lower limit of the sunless seas")
...
setting("int", "oil_sea_level", -11552, "Oil sea level")

setting("bool", "enable_lava_sea", true, "Enable magma sea")
setting("int", "lava_sea_level", -12052, "Lava sea level")
...
setting("int", "underworld_level", -12552, "Underworld level")
...
setting("int", "primordial_max", -13073, "Upper limit to primordial caverns")
setting("int", "primordial_min", -16032, "Lower limit to primordial caverns")
