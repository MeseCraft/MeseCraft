...
mobs:register_mob("mobs_creatures:kangaroo", {
	type = "animal",
	hp_min = 28,
	hp_max = 28,
	armor = 140,
	...
	sounds = {
		random = "mobs_creatures_kangaroo",
	},
	drops = {
		{name = "mobs:meat_raw", chance = 1, min = 6, max = 9},
		{name = "mobs:leather", chance = 1, min = 2, max = 3},
		{name = "mobs_creatures:bone", chance = 1, min = 1, max = 2},
	},
	visual = "mesh",
	visual_size = {x=6, y=6},
	collisionbox = {-0.5, -0.8, -0.5, 0.5, 0.4, 0.5},
	textures = {
		{"mobs_creatures_kangaroo.png"},
	},
	child_texture = {
		{"mobs_creatures_kangaroo_child.png"},
	},
	mesh = "mobs_creatures_kangaroo.b3d",
	animation = {
		speed_normal = 40,
		speed_sprint = 85,
		stand_start = 50,
...
-- Spawn Egg
mobs:register_egg("mobs_creatures:kangaroo", "Kangaroo Spawn Egg", "default_dry_grass.png", 1)

-- Spawn Parameters, spawns in Savannah near dry grass or air during the day.
mobs:spawn_specific("mobs_creatures:kangaroo", {"default:dry_dirt_with_dry_grass"}, {"group:dry_grass"}, 7, 16, 240, 2000, 6, 1, 150, true)
