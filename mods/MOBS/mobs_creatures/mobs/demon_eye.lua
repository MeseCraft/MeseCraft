...
mobs:register_mob("mobs_creatures:demon_eye", {
   type = "monster",
   passive = false,
   damage = 4,
   reach = 2,
   ...
   visual = "mesh",
   mesh = "mobs_creatures_demon_eye.b3d",
   textures = {
      {"mobs_creatures_demon_eye.png"},
   },
...
mobs:spawn_specific("mobs_creatures:demon_eye", {"group:leaves"}, {"air"}, 0, 6, 60, 2000, 4, 5, 175, false)

-- REGISTER SPAWN EGG
mobs:register_egg("mobs_creatures:demon_eye", "Demon Eye Spawn Egg", "wool_red.png", 1)
