...
p = {
  ...
  {act = 'fill', node = 'default:stone', coords = {61, 2, 50, 1, 13, 2}},
...
p = {
  ...
  {act = 'fill', node = 'default:stone', coords = {1, 2, 21, 3, 58, 1}},
  {act = 'fill', node = 'default:stone', coords = {21, 1, 21, 3, 39, 2}},
  {act = 'fill', node = 'default:stone', coords = {6, 2, 21, 3, 12, 1}},
  {act = 'fill', node = 'default:stone', coords = {38, 1, 21, 3, 9, 2}},
  {act = 'fill', node = 'default:stone', coords = {41, 1, 21, 3, 9, 2}},
  {act = 'fill', node = 'default:stone', coords = {59, 2, 21, 3, 23, 1}},
  {act = 'fill', node = 'default:stone', coords = {13, 2, 31, 3, 67, 1}},
  {act = 'fill', node = 'default:stone', coords = {13, 2, 31, 3, 34, 1}},
}
...
p = {
  ...
  {act = 'fill', node = 'default:water_source', coords = {19, 2, 23, 1, 9, 2}},
  ...
  {act = 'fill', node = 'default:water_source', coords = {19, 2, 23, 1, 24, 2}},
  ...
  {act = 'fill', node = 'default:water_source', coords = {19, 2, 23, 1, 39, 2}},
  ...
  {act = 'fill', node = 'default:water_source', coords = {19, 2, 23, 1, 54, 2}},
  ...
  {act = 'fill', node = 'default:water_source', coords = {19, 2, 23, 1, 69, 2}},
  ...
  {act = 'fill', node = 'default:stone', coords = {55, 2, 30, 1, 50, 2}},
...
p = {
  ...
  {act = 'fill', node = 'default:stone', coords = {64, 1, 21, 3, 20, 1}},
